    ...
    class Program
    {
        ...
        static void GerarRelatorioEmPDF(int qtdePessoas)
        {
            ...
            if (pessoasSelecionadas.Count > 0)
            {
                ...
                var pxPorMm = 72 / 25.2F; // Relação entre a quantidade de pixels(px = 72) por milimetro(mm = 25.5F)
                ...
                var link = new Chunk("GitHub do Roberto Vieira Carlos", fonteLink);
                link.SetAnchor("https://github.com/beto-desenv");
                ...
                //adição das células de título das colunas                
